...
- `me()`: `session, guid, name, level, health, health_max, stamina, stamina_max, mana, mana_max, x, y, z, cell, combat, magic, target, target_name, selected, placed, vendor_open, container_open` (`target`/`selected` are guids or `()`)
