...
# O the components panel, U the buffs, F the fellowship, X the character
# options; server questions such as a fellowship invitation pop up with Yes/No). C toggles combat in the stance of
